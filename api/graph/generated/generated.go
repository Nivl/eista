...
func (ec *executionContext) marshalOSession2ᚖgithubᚗcomᚋNivlᚋeistaᚑapiᚋservicesᚋuserᚋpayloadᚐSession(ctx context.Context, sel ast.SelectionSet, v *payload.Session) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
